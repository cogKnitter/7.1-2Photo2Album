...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Albums = __webpack_require__(221);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IndividualAlbum = __webpack_require__(222);

	var _IndividualAlbum2 = _interopRequireDefault(_IndividualAlbum);
	...
	exports.default = _react2.default.createClass({
	  ...
	  onHandleClickChangeAlbum: function onHandleClickChangeAlbum(e) {
	    this.setState({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'section',
	        { className: 'albums__links--list' },
	        this.props.albums.map(function (album, i) {
	          return _react2.default.createElement(
	            'h2',
	            { key: i, className: 'albums__links' },
	            _react2.default.createElement(
	              _reactRouter.Link,
	              { className: 'link', id: album.id, onClick: this.onHandleClickChangeAlbum, to: '/albums/' + album.album_name },
	              album.album_name
	            )
	          );
	        }, this)
	      ),
	      _react2.default.createElement(_IndividualAlbum2.default, { album: this.state.currentAlbum })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  ...
	  onHandleClickExpandImage: function onHandleClickExpandImage(e) {
	    this.setState({
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        this.props.album.images.map(function (image, i) {
	          return _react2.default.createElement(
	            'span',
	            { key: i, className: 'photo__wrapper' },
	            _react2.default.createElement('img', { className: 'single__image', key: i, id: i, onClick: _this.onHandleClickExpandImage, src: '/assets/' + image.image_src, alt: image.image_title })
	          );
	        }, this)
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: this.state.modalCover ? "modalShow" : "modalHide" },
	        ' ',
	        _react2.default.createElement(
	          'h2',
	          { className: 'exit__modal', onClick: this.onHandleClickExitModal },
	          'X'
	        ),
	        _react2.default.createElement('i', { className: 'fa fa-arrow-left fa-2x', onClick: this.onHandleClickPrev }),
	        _react2.default.createElement('img', { className: 'modal__image', ref: 'modalImage', id: this.state.currentImageID, src: '/assets/' + this.state.currentImage.image_src }),
	        _react2.default.createElement('i', { className: 'fa fa-arrow-right fa-2x', onClick: this.onHandleClickNext })
	      )
	    );
	  }
	});
